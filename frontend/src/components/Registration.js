		...
		<div className="registration">
			<form method="POST">
				<fieldset className="login__fieldset" disabled={ disabled } >
					...
					<input type="password" className="login__field" name="password" placeholder="Repeat password" value={ repeatPassword } onChange={ onRepeatPasswordChange } required/>
					<button type="submit" className="login__button login__button--primary" onClick={ register }>Register</button>
					<Link to="/register" className="login__button login__button--secondary">Login</Link>
				</fieldset>
			</form>
		</div>
	);
